The client makes at most three total attempts by default. It retries HTTP 503, with a delay of 100 milliseconds between attempts. It returns the final response when attempts are exhausted. [Client](client.py:3-15)
