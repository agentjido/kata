...
An entry expires when its age is strictly greater than the TTL. It is removed and get returns undefined. [Lookup](cache.ts:12-19)

Zero TTL disables caching: put returns without storing an entry. [Insertion](cache.ts:7-9)
