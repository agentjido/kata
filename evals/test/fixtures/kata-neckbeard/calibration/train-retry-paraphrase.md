The default number of attempts is 3. It retries only HTTP 503, with a delay of 0.1 seconds between attempts. It returns the final response when attempts are exhausted. [Client](client.py:3-15)
